...
public class Main {
    public static void main(String[] args) {
        ...
        for(Portion p :menu)System.out.println(p);
        Container[] containers = new Container[MENUS];
        for(int m = 0; m < MENUS; m++) {containers[m] = Container.create(menu[m]);}
    ...
    // o construtor devia de ser protected para evitar que a classe main tenha acesso as coisas todas
}